...
(function () {
	...
	$(function () {
		...
		function attachFormValidator(elements) {
			...
			regula.custom({
				name: 'PhoneNumber',
				defaultMessage: 'פורמט מספר טלפון לא חוקי',
				validator: function() {
			...
			var regularConstraintsMessages = [
				{
					...
					newMessage: "שדה הטקסט חובה"
				},
				{
					type: regula.Constraint.Email,
					newMessage: "המייל אינו אימייל חוקי"
				},
				{
					type: regula.Constraint.Numeric,
					newMessage: "רק מספרים נדרשים"
				},
				{
					type: regula.Constraint.Selected,
					newMessage: "בבקשה תבחר אופציה"
				}
			];
...
function openContactForm ($this){
	var element = document.getElementById('md-navbar-aside');
	element.classList.add("active");
	var element2 = document.getElementById('rd-navbar-aside');
